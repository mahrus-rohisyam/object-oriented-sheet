...
/**
 * @EN There will be an error if we access area() method.
 * The cause is private in the ShapeOperation class.
 * 
 * @ID Akan muncul error ketika kita mencoba untuk mengakses method area().
 * Penyebabnya adalah private pada class ShapeOperation.
 */
